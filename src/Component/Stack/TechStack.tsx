        ...
        <div >
            <div className="max-w-6xl mx-auto flex justify-between items-center mt-10">
                <div className="flex flex-col gap-2.5">
                    <h1 className="text-3xl font-bold ">Explore the <span className="bg-[linear-gradient(to_right,#FF5722,#D81B7E,#7C3AED)] bg-clip-text text-transparent ">Technologies</span></h1>
